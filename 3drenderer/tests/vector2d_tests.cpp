...
namespace vector2d_tests
{
	...
	TEST(vector2d, vars)
	{
		vector::Vector2d<double> v2d{ 1.0, 1.0 };
	...
	{
		vector::Vector2d<double> v2d{ 3.0, 4.0 };
	...
	{
		vector::Vector2d<double> v2d{ 3.0, 4.0 };
		vector::Vector2d<double> v2d2{ 1.0, 1.0 };
		v2d += v2d2;
	...
	TEST(vector2d, operator_plus)
	{
		vector::Vector2d<double> v2d{ 3.0, 4.0 };
		vector::Vector2d<double> v2d2{ 1.0, 1.0 };
		vector::Vector2d<double> v2d3 = v2d + v2d2;
	...
	{
		vector::Vector2d<double> v2d{ 2.0, 4.0 };
		v2d /= 2.0;
		EXPECT_EQ(v2d.m_x, 1.0);
